...
public class WifiResultsAdapter extends RecyclerView.Adapter<WifiResultsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        dist = Math.pow(10d, ((double) -34 - results.get(position).level) / (30));
        holder.level.setText(String.valueOf("RSSI: "+results.get(position).level+ " Dist: "+Math.floor(dist * 100) / 100) + "m");
